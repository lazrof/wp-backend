...
<div class="page-hero-section bg-image hero-home-1" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/img/bg_hero_1.svg);">
      ...
      <div class="row align-items-center h-100">
        ...
        <div class="col-lg-6 d-none d-lg-block wow zoomIn">
          <div class="img-place mobile-preview shadow floating-animate">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/app_preview_1.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/alter_sport.png" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/cleaning_service.png" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/creative_photo.png" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/global_tv.png" alt="">
        </div>
      </div>
    </div>
  </div>
...
<div class="position-realive bg-image" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/img/pattern_1.svg);">
    ...
    <div class="row">
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/app_preview_2.png" alt="">
        </div>
      </div>
...
<div class="page-section">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/app_preview_3.png" alt="">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-center mt-5">
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn">
          <div class="mb-3">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/rocket.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="200ms">
          <div class="mb-3">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/testimony.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="400ms">
          <div class="mb-3">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/promotion.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="600ms">
          <div class="mb-3">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/coins.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="800ms">
          <div class="mb-3">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/support.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="1000ms">
          <div class="mb-3">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/laptop.svg" alt="">
          </div>
