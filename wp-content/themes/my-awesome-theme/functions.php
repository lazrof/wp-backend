...
if ( ! function_exists( 'my_awesome_theme_setup' ) ) :
	...
	function my_awesome_theme_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'my-awesome-theme' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'my_awesome_theme_custom_background_args',
				array(
...
function my_awesome_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'my_awesome_theme_content_width', 640 );
}
...
function my_awesome_theme_scripts() {
	...
	wp_enqueue_script( 'my-awesome-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
